...
@SourceType(value = "AzureSynapseARP", label = "AzureSynapse",uiConfig = "azuresynapse-layout.json")
public class AzureSynapseConf extends AbstractArpConf<AzureSynapseConf> {
  private static final String ARP_FILENAME = "arp/implementation/azuresynapse-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.azuresynapse.AzureSynapseDriver";
